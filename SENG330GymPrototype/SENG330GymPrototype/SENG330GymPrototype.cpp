// SENG330GymPrototype.cpp : Defines the entry point for the console application.
//
...
int main(int argc, char** argv)
{
	...
	/*Initializes the member factory's cloning machines*/
	MemberFactory member_factory;

	/*Creating samples*/
	Customer* customer1 = member_factory.getCustomer();
	customer1->initialize("John Doe", "123 Maple Rd", 123456789, 987654321, Customer::SubscriptionLevel::BASIC);
	customer1->print();
	cout << endl;

	Staff* test_staff = member_factory.getStaff();
	test_staff->initialize("Mary Janes", "420 Dank Hill", 2214356879, 9786534120, Staff::Clearance::MANAGER);
	test_staff->print();
	cout << endl;

	Staff* test_staff2 = member_factory.getStaff();
	test_staff2->initialize("CLONE", "AREA 51 CLONE", 12342143354245, 112341234, Staff::Clearance::GENERAL);
	test_staff2->print();
	cout << endl;
